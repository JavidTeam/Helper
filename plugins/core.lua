...
local lang = redis:get(hash) 
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '> About Us ', callback_data = '/javid:'..GP_id}
		},
		{
  ...
  elseif lang then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '> درباره ما ', callback_data = '/javid:'..GP_id}
		},
		{
...
local settings = data[tostring(GP_id)]["settings"]
 ...
 text = '_Welcome To_ *More Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> Flood Sensitivity ', callback_data = 'Javid_Team'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="Javid_Team"},
			{text = "➖", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = '> Character Sensitivity ', callback_data = 'Javid_Team'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="Javid_Team"},
			{text = "➖", callback_data='/chardown:'..GP_id}
		},
		{
			{text = '> Flood Check Time ', callback_data = 'Javid_Team'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="Javid_Team"},
 ...
 text = '_به تنظیمات بیشتر خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> حداکثر پیام های مکرر ', callback_data = 'Javid_Team'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="Javid_Team"},
		...
		{
			{text = '> حداکثر حروف مجاز ', callback_data = 'Javid_Team'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="Javid_Team"},
		...
		{
			{text = '> زمان بررسی پیام های مکرر ', callback_data = 'Javid_Team'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="Javid_Team"},
...
local lang = redis:get(hash) 
 ...
 text = '_به تنظیمات گروه خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = "> قفل ویرایش", callback_data='Javid_Team'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "> قفل لینک", callback_data='Javid_Team'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "> قفل تگ", callback_data='Javid_Team'}, 
			{text = lock_tag, callback_data="/locktags:"..GP_id}
		},
		{
			{text = "> قفل ورود", callback_data='Javid_Team'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "> قفل پیام های مکرر", callback_data='Javid_Team'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "> قفل هرزنامه", callback_data='Javid_Team'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "> قفل فراخوانی", callback_data='Javid_Team'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "> قفل عربی", callback_data='Javid_Team'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "> قفل صفحات وب", callback_data='Javid_Team'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "> قفل فونت", callback_data='Javid_Team'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "> قفل سنجاق کردن", callback_data='Javid_Team'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "> قفل ربات ها", callback_data='Javid_Team'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		{
			{text = "> خوشآمد گویی", callback_data='Javid_Team'}, 
			{text = group_welcone, callback_data="/welcome:"..GP_id}
		},
		{
...
local lang = redis:get(hash) 
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> بیصدا همه", callback_data='Javid_Team'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "> بیصدا تصاویر متحرک", callback_data='Javid_Team'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "> بیصدا متن", callback_data='Javid_Team'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "> بیصدا اینلاین", callback_data='Javid_Team'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "> بیصدا بازی", callback_data='Javid_Team'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "> بیصدا عکس", callback_data='Javid_Team'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "> بیصدا فیلم", callback_data='Javid_Team'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "> بیصدا آهنگ", callback_data='Javid_Team'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "> بیصدا صدا", callback_data='Javid_Team'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "> بیصدا استیکر", callback_data='Javid_Team'}, 
			{text = mute_sticker, callback_data="/mutesticker:"..GP_id}
		},
		{
			{text = "> بیصدا مخاطب", callback_data='Javid_Team'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "> بیصدا نقل و قول", callback_data='Javid_Team'}, 
			{text = mutes.mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "> بیصدا موقعیت", callback_data='Javid_Team'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "> بیصدا فایل", callback_data='Javid_Team'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "> بیصدا خدمات تلگرام", callback_data='Javid_Team'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "> بیصدا کیبورد", callback_data='Javid_Team'}, 
			{text = mute_keyboard, callback_data="/mutekeyboard:"..GP_id}
		},
		{
			{text = '> بازگشت ', callback_data = '/option:'..GP_id}
...
local keyboard = {} 
		...
		edit_inline(msg.message_id, text, keyboard)
         ...
         -- ####################### About Us ####################### --
if matches[1] == '/javid' then
	local text = _config.info_text
    if not lang then
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = "> Javid", callback_data="/Javid:"..matches[2]}, 
			{text = "> toofan", callback_data="/toofan:"..matches[2]}
		},
		{
			{text = '> Our GitHub ', url = 'https://www.github.com/JavidTeam'}
		},
		{
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> جاوید", callback_data="/Javid:"..matches[2]}, 
			{text = "> طوفان", callback_data="/toofan:"..matches[2]}
		},
		{
			{text = '> گیت هاب تیم ', url = 'https://www.github.com/JavidTeam'}
		},
		{
...
if matches[1] == '/Javid' then
local text = [[*》Javid Information《*
*》Bridges :《*
_》Pv : _[@Ali_K_1999](Telegram.Me/Ali_K_1999)
_》PvResan : _[@Ali_K_1999 Pv](Telegram.Me/Ali_K_1999Bot)
*-------------------------*]]
  if not lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "> Back", callback_data="/javid:"..matches[2]}
			}
		}
  elseif lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "> بازگشت", callback_data="/javid:"..matches[2]}
			}
		}
  end
    edit_inline(msg.message_id, text, keyboard)
