...
bot_token = "369575991:AAEYnv6ULmWi3QMkoxsZ-p22DEpdSLq9rkA" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		Javid_Team = '/root/TeleJavid'
	elseif not server_user:match("^root$") then
		Javid_Team = '/home/'..server_user..'/TeleJavid'
	end
  ...
  config = {
    ...
    sudo_users = {226399128,393217901},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..Javid_Team..'/data/moderation.json'},
    info_text = [[*》Javid Helper Bot V1.5*
`》An helper bot of` *TeleJavid* `based on` *Messenger*

》[Javid Helper](https://github.com/JavidTeam/Helper)

*》Admins :*
*》Founder & Developer :* [Javid](Telegram.Me/Ali_K_1999)

*》Our channel :*
》[Javid_Team](Telegram.Me/Javid_Team)
]],
  }
